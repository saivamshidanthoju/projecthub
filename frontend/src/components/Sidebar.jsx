        ...
        <div className="flex items-center gap-sm mb-lg px-xs">
          ...
          <div>
            ...
            <p className="font-label-md text-label-md text-on-surface-variant dark:text-surface-variant leading-none uppercase tracking-widest text-[10px]">
              {pathname === "/calendar" ? "Enterprise Tier" : "Enterprise SaaS"}
            </p>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-sm py-sm active:scale-[0.98] transition-all duration-200 ${
                  isActive
                    ? "bg-secondary-container text-on-secondary-container dark:bg-on-surface-variant dark:text-surface-main border-l-[3px] border-primary pl-3 pr-md rounded-r-lg rounded-l-none"
                    : "text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-high dark:hover:bg-on-surface-variant/50 px-md rounded-lg"
                }`}
              >
          ...
          {pathname === "/project-details" ? (
            ...
            <>
              ...
              <div className="mt-md p-sm bg-surface-container dark:bg-on-surface-variant/20 rounded-xl flex items-center gap-sm">
                ...
                <div className="overflow-hidden">
                  <p className="font-title-md text-sm font-semibold truncate text-on-surface dark:text-surface-main">John Doe</p>
                  <p className="font-body-sm text-[10px] text-on-surface-variant dark:text-surface-variant uppercase">ADMIN</p>
                </div>
              </div>
            </>
          ) : (
